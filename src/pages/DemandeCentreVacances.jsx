...
export default function DemandeCentreVacances() {
    ...
    <>
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          td:nth-of-type(1):before { content: "Champ"; }
          td:nth-of-type(2):before { content: "Premier choix (obligatoire)"; }
          td:nth-of-type(3):before { content: "Deuxième choix (facultatif)"; }
          td:nth-of-type(4):before { content: "Troisième choix (facultatif)"; }
        }
       .add-choice-btn {
  cursor: pointer;
  font-weight: bold;
  ...
  opacity: 1 !important;    /* make sure fully visible */
...
.add-choice-btn:hover {
  ...
  <p style={{ fontWeight: 'bold', color: '#aa0000', lineHeight: '1.6' }}>
    ...
    La demande doit être déposée au minimum trois jours avant la date d’entrée au centre.
        ...
        {/* Bouton Enregistrer et message de confirmation */}
<div style={{ textAlign: 'center', marginTop: '30px' }}>
  {!showMessage ? (
    ...
    >
      Merci, vous pouvez imprimer votre demande dans <strong>historique</strong>.
    </p>
  )}
</div>
      </div>
